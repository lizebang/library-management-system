...
public class Util {
    ...
    public final static Integer deleteUser(String id, Integer isAdmin)  throws LibraryException, JSONException, IOException {
        ...
        NameValuePair[] reqBody = {
            new NameValuePair(User.UserId, id),
        };
    ...
    public final static User[] getUserByName(String name, int page) throws LibraryException, JSONException, IOException {
    ...
    public final static User getUserById(String id) throws LibraryException, JSONException, IOException {
    ...
    public final static User[] getAllUser(int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Integer addBook(String isbn, String mark, String name, String tag, String author, String introduction, String amount, String inventory, Integer isAdmin) throws LibraryException, JSONException, IOException {
        if (isAdmin != Constant.AdminUser) {
            throw new LibraryException(Constant.Permission_Denied);
        }
        ...
        NameValuePair[] reqBody = {
            new NameValuePair(Book.BookIsbn, isbn),
            new NameValuePair(Book.BookMark, mark),
            new NameValuePair(Book.BookName, name),
            new NameValuePair(Book.BookTag, tag),
            new NameValuePair(Book.BookAuthor, author),
    ...
    public final static Integer deleteBook(String isbn, Integer isAdmin)  throws LibraryException, JSONException, IOException {
        if (isAdmin != Constant.AdminUser) {
            throw new LibraryException(Constant.Permission_Denied);
        }
    ...
    public final static Book getBookByIsbn(String isbn) throws LibraryException, JSONException, IOException {
        ...
        try {
            ...
            if (!status.equals(Constant.HTTP_OK)) {
                ...
                Book book = new Book(
                    body.getLong(Book.BookId),
                    body.getString(Book.BookIsbn),
                    body.getString(Book.BookMark),
                    body.getString(Book.BookName),
                    body.getString(Book.BookTag),
                    body.getString(Book.BookAuthor),
                    body.getString(Book.BookIntroduction),
                    body.getInt(Book.BookAmount),
    ...
    public final static Book[] getBookByAuthor(String author, int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Book[] getBookByTag(String tag, int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Book[] getBookByKeyword(String keyword, int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Book[] getBookFuzzy(String keyword, int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Book[] getAllBook(int page) throws LibraryException, JSONException, IOException {
    ...
    public final static Integer borrowBook(String isbn) throws LibraryException, JSONException, IOException {
        PostMethod postMethod = new PostMethod(Event_Borrow);

        NameValuePair[] reqBody = {
            new NameValuePair(Event.EventIsbn, isbn),
        };
    ...
    public final static Integer returnBook(String isbn) throws LibraryException, JSONException, IOException {
    ...
    public final static Event[] getEventByPhone() throws LibraryException, JSONException, IOException {
            ...
            if (!status.equals(Constant.HTTP_OK)) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    Event event = new Event(
                        body.getLong(Event.EventId),
                        body.getString(Event.EventPhone),
                        body.getString(Event.EventIsbn),
                        body.getString(Event.EventName),
                        body.getString(Event.EventTag),

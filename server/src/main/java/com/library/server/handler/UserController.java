...
public class UserController {
    ...
    public @ResponseBody Map<String, Object> resetUser(@RequestParam String name,
    ...
    public @ResponseBody Map<String, Object> changeInfo(@RequestParam String name,
            @RequestParam Integer sex, HttpServletRequest request) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public @ResponseBody Map<String, Object> changePhone(@RequestParam String newPhone,
    ...
    public @ResponseBody Map<String, Object> changePassword(@RequestParam String oldPassword,
    ...
    public @ResponseBody Map<String, Object> getUsersByName(@RequestParam String name,
            @RequestParam int page) {
        Map<String, Object> map = new HashMap<String, Object>();

        Page<User> users =
                userRepository.findUserByName(name, new PageRequest(page - 1, Constant.Page_Size));
        if (users != null) {
            map.put(Constant.Status, Constant.HTTP_OK);
